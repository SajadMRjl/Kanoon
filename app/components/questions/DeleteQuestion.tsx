...
import deleteQuestion from "@/app/api/deleteQuestion";
...
export default function DeleteQuestion(inputProps: Props) {
    ...
    >
      <div className="container">
        <div className="delete-header">
          ...
          <div className="text">حذف سوال</div>
        </div>
        <div className="ensure-text">آیا از حذف سوال مطمئن هستید ؟</div>
